		...
		<table id="example" class="display" cellspacing="0" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center"><%= camiones.get(i).getKmRecorridosDesdeMantenimiento() %>
					</td>
					<td align="center"><%= camiones.get(i).getKmRecorridosEnViaje() %>
					</td>
					<td align="center"><%= camiones.get(i).dameNombreEstado(camiones.get(i).getEstado()) %>
					</td>
				</tr>
				<% } %>
			</tbody>
